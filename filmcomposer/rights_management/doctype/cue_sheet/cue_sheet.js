...
frappe.ui.form.on('Cue Sheet', 'setup', function(frm) {
...
frappe.ui.form.on('Cue Sheet', 'onload', function(frm) {
...
frappe.ui.form.on('Cue Sheet', 'spotting_notes_id', function(frm) {
